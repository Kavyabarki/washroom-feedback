...
import MeetingImage from './wayfinding.png'; // Adjust the path to your image
        ...
        <a href="http://164.52.197.111:3006/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
            <CardWrapper border={false} content={false}>
                <Box sx={{ p: 2.25, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column' }}>
                    <Typography sx={{ color: 'black', fontSize: '20px', mb: 1, textAlign: 'center', fontWeight: 'bold' }}>
                        {title}
                    </Typography>
                    <Box sx={{ flex: 1, width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', mt: -4 }}>
                        <img src={MeetingImage} alt="Indoor Air Quality" style={{ maxWidth: '100%', maxHeight: '150px', objectFit: 'cover' }} />
                    </Box>
